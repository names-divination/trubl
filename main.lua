...
local CONFIG = {
    ...
    Colors = {
        ...
        RowStrokeOn = Color3.fromRGB(255, 215, 0),
        RowStrokeOff= Color3.fromRGB(80, 65, 20),
        Text        = Color3.fromRGB(240, 240, 240),
        SubText     = Color3.fromRGB(130, 130, 130),
        KeyBindBG   = Color3.fromRGB(20, 20, 20),
        ActiveMode  = Color3.fromRGB(212, 175, 55),
        InactiveMode= Color3.fromRGB(80, 65, 20), 
    },
    Size = {
